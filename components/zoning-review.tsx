            ...
            <div className="space-y-6">
              <Card className="bg-card">
                ...
                <CardContent>
                  <div
                    className={cn(
                      "border-[1.25px] border-dashed rounded-xl p-4 md:p-12 text-center transition-colors [border-style:dashed] [border-image:repeating-linear-gradient(90deg,rgba(0,0,0,0.2),rgba(0,0,0,0.2) 3px,transparent 3px,transparent 6px)_1] border-image-slice-1",
                      isDragging
                        ...
                        <table className="w-full">
                          <thead>
                            <tr className="border-b">
                              <th className="text-left py-2 text-sm font-medium text-muted-foreground whitespace-nowrap">Requirement</th>
                              <th className="text-left py-2 text-sm font-medium text-muted-foreground whitespace-nowrap">Value</th>
                              <th className="text-left py-2 text-sm font-medium text-muted-foreground whitespace-nowrap">Status</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr className="border-b">
                              <td className="py-3 text-sm text-card-foreground whitespace-nowrap">Maximum Height</td>
                              <td className="py-3 text-sm text-card-foreground whitespace-nowrap">120 feet</td>
                              <td className="py-3">
                                <Badge className="bg-success text-primary-foreground">Compliant</Badge>
                              </td>
                            </tr>
                            <tr className="border-b">
                              <td className="py-3 text-sm text-card-foreground whitespace-nowrap">Floor Area Ratio</td>
                              <td className="py-3 text-sm text-card-foreground whitespace-nowrap">4.0 max</td>
                              <td className="py-3">
                                <Badge className="bg-success text-primary-foreground">Compliant</Badge>
                              </td>
                            </tr>
                            <tr className="border-b">
                              <td className="py-3 text-sm text-card-foreground whitespace-nowrap">Lot Coverage</td>
                              <td className="py-3 text-sm text-card-foreground whitespace-nowrap">75% max</td>
                              <td className="py-3">
                                <Badge className="bg-success text-primary-foreground">Compliant</Badge>
                              </td>
                            </tr>
                            <tr className="border-b">
                              <td className="py-3 text-sm text-card-foreground whitespace-nowrap">Setback (East)</td>
                              <td className="py-3 text-sm text-card-foreground whitespace-nowrap">15' required</td>
                              <td className="py-3">
                                <Badge variant="destructive">Violation</Badge>
                              </td>
                            </tr>
                            <tr>
                              <td className="py-3 text-sm text-card-foreground whitespace-nowrap">Parking Ratio</td>
                              <td className="py-3 text-sm text-card-foreground whitespace-nowrap">1:300 SF</td>
                              <td className="py-3">
                                <Badge className="bg-success text-primary-foreground">Compliant</Badge>
                              </td>
                            </tr>
